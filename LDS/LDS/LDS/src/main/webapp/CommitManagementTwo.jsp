...
<body>
	...
	<div class="container">
		...
		<!-- toolbar -->
		<form class="navbar-form" action="Commits.do">
					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
								<input name="action" type="submit"
									...
									<input name="action" type="submit" class="btn" value="submit"></input> 
...
<!-- 									value="ok">OK</button> -->
							...
							<table>
								...
								<c:forEach var="temp" items="${data}">
									<tr>
										<td>${temp.getCommitId()}  </td>
										<td>${temp.isArchived()}  </td>										
										<td><input name="commit" type="radio" class=""
											value="${temp.getCommitId()}"></input>  </td>
									</tr>
								</c:forEach>
							</table>
