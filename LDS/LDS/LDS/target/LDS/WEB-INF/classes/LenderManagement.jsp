		...
		<div class="row">
			<div class="span4">
				...
				<form class="form-horizontal" action="CreateLender.do">
					...
					<input name="process" type="radio" class="" value="Create Lender">Create Lender</input> 
					<input name="process" type="radio" class="" value="Edit Lender">Edit Lender</input> 
					<input type="submit" class="btn" value="Create Lender"></input>

				</form>
			</div>
			<div class="span4">
				<h2>View Lender</h2>
				<form class="form-horizontal" action="ViewLender.do">

					<input name = "lenderId" class="span2" placeholder="Lender ID" type="text"> <input
						type="submit" class="btn" value="View Lender"></input>
