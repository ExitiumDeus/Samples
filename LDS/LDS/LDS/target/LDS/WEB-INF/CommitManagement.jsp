	...
	<div class="container">
		...
		<div class="row">
			<div class="span4">
				...
				<form class="form-horizontal" uri="CreateCommit.do">
					<div class="controls">
						<input type="submit" class="btn">Commit Lender</input>
					</div>
			</div>
			</form>
		</div>
		<div class="span4">
			<h2>View Commit</h2>
			<p></p>
			<form class="form-horizontal" uri="ViewCommit.do">
				<div class="control-group">
					<div class="controls">
						<input class="span2" placeholder="Commit ID" type="text">
						<input type="submit" class="btn">View Commit</input>
					</div>
				</div>
			</form>
		...
		<div class="span4">
			...
			<form class="form-horizontal" uri="EditCommit.do">
				<div class="control-group">
					<div class="controls">
						<input class="span2" placeholder="Loan ID" type="text"> <input
							class="span2" placeholder="Commit ID" type="text"> <input
							type="submit" class="btn">Remove Loan</input>
					</div>
				</div>
			</form>
		</div>
		<div class="span4">
			...
			<p></p>
			<p>
			<form class="form-horizontal" uri="AddLoan.do">
				<div class="control-group">
					<div class="controls">
						<input class="span2" placeholder="Loan ID" type="text"> <input
							class="span2" placeholder="Commit ID" type="text"> <input
							type="submit" class="btn">Add Loan</input>
					</div>
				</div>
			</form>
			</p>
