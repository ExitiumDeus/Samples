	...
	<div class="container">
		...
		<div class="row">
			<div class="span4">
				...
				<form class="form-horizontal" action="LoanManagement.do">
			...
			<div class="span4">
				...
				<form class="form-horizontal" action="CommitManagement.do">
			...
			<div class="span4">
				...
				<form class="form-horizontal" action="LenderManagement.do">
